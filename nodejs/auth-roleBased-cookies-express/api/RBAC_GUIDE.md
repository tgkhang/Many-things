...
2. Register and login to get authentication cookies:
```bash
# Register
...
3. The login response will set cookies automatically. Make sure your HTTP client includes cookies in subsequent requests.
...
├── src/
│   ├── middlewares/
│   │   ├── rbacMiddleware-LV1.js    # Simple role-based
│   │   ├── rbacMiddleware-LV2.js    # Permission-based
│   │   └── rbacMiddleware-LV3.js    # Role inheritance
│   ├── routes/
│   │   └── v1/
│   │       └── rbacRoute.js         # Test routes for all levels
│   └── utils/
│       └── constants.js              # MOCK_ROLES_LV2, MOCK_ROLES_LV3
...
This RBAC implementation is part of the auth-roleBased-cookies-express template.

---

## Questions?

Check the code examples in [src/routes/v1/rbacRoute.js](src/routes/v1/rbacRoute.js:1-345) for comprehensive usage examples!
